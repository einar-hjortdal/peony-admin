...
export default freeze({
  ...
  'categories.newCategory.name': 'name',
  'categories.newCategory.description': 'description',
  'categories.newCategory.handle': 'handle',
  'categories.newCategory.visibility': 'visibility',
  'categories.newCategory.status': 'status',
